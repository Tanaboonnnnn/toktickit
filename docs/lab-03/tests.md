...
| REQ-01 | API | FR-06, FR-07; AC-08 | Authenticated create/list/detail/query behavior | Retained Requester behavior succeeds | `server/tests/lab-03/requester-regression.api.test.ts` | Planned / Not run |
...
| UI-01 | UI | FR-01–FR-04; AC-01, AC-02, AC-05, AC-06 | Login/Change Password/auth bootstrap/logout states | Correct safe UI states | `client/tests/lab-03/Login.test.tsx`; `ChangePassword.test.tsx`; `AuthShell.test.tsx` | Planned / Not run |
