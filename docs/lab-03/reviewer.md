...
- PR #64 was merged into `lab3-staging` as `51f2b4bc710025c92eb17173c9d17efca8aef50d` **before the final requested evidence-data cleanup and re-review cycle was finished**. This was an accidental early merge by a collaborator, not a completed peer-approval gate and not a release to `main`.
...
- The corrective follow-up must not be represented as a rewrite of PR #64 history. The historical early merge remains visible and the follow-up PR documents why it exists.
