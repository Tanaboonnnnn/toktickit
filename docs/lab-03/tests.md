...
| `npm.cmd run verify` | Pass on the Issue #43 product candidate: server 36 files / 180 tests, client 18 files / 123 tests, retained E2E 23/23, dedicated responsive 10/10; server/client builds passed |
