...
const ROLE_CAPABILITIES: Readonly<Record<UserRole, ReadonlySet<Capability>>> = {
  REQUESTER: new Set(["REFERENCE_DATA_READ", "REQUESTER_TICKET_CREATE", "REQUESTER_TICKET_READ_OWN", "REQUESTER_ATTACHMENT_MANAGE_OWN", "PUBLIC_COMMENT"]),
  IT_STAFF: new Set(["REFERENCE_DATA_READ", "STAFF_TICKET_QUEUE", "STAFF_TICKET_OPERATE", "PUBLIC_COMMENT", "INTERNAL_NOTE"]),
  ADMINISTRATOR: new Set(["REFERENCE_DATA_READ", "STAFF_TICKET_QUEUE", "STAFF_TICKET_OPERATE", "PUBLIC_COMMENT", "INTERNAL_NOTE", "ADMIN_USER_MANAGE"]),
};
