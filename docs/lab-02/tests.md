...
- UI-05 Ticket-create portion: 1 test file / 8 tests passed, including definitive HTTP 500 retry with the same logical request; UI-05 remains Planned because its full planned scope also includes post-create Attachment-upload behavior deferred to a later Issue.
...
- Full client suite: `8` test files / `74` tests passed.
